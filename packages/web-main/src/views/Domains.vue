<template>
  <div class="domains">
    <div class="container">
      <div class="header">
        <h1>Domains</h1>
        <button class="btn btn-primary" @click="showAddDomain = true">
          Add Domain
        </button>
      </div>
          ...
          <div class="card" v-for="domain in domainsStore.domains" :key="domain.id">
            <div class="domain-header">
              ...
              <div class="domain-actions">
                <button class="btn btn-secondary btn-sm" @click="editDomain(domain)">
                  Edit
                </button>
            ...
            <div class="domain-info">
              ...
              <div class="domain-settings">
                <label>
                  <input type="checkbox" v-model="domain.autoRenew" @change="updateDomain(domain)">
                  Auto-renew
                </label>
                <label>
                  <input type="checkbox" v-model="domain.notificationEnabled" @change="updateDomain(domain)">
                  Notifications
                </label>
              </div>
            </div>
      ...
      <div class="modal" @click.stop>
        ...
        <form @submit.prevent="addDomain">
          ...
          <div class="modal-actions">
            <button type="button" class="btn btn-secondary" @click="showAddDomain = false">
              Cancel
            </button>
            <button type="submit" class="btn btn-primary" :disabled="domainsStore.loading">
              Add Domain
            </button>
          </div>
        </form>
